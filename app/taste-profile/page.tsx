...
import { TasteProfilePanel } from "@/src/components/taste/TasteProfilePanel";
        ...
        <header className="bg-[#0f1b24]/85 border border-[#1b3a40] p-4 rounded-2xl backdrop-blur">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              >
                ← {t("taste.backToDashboard")}
              </Link>
              <h1 className="text-xl font-semibold text-white">{t("taste.pageTitle")}</h1>
            </div>
